...
def get_market_data():
    # 🌟 الرابط الصحيح لبينانس مدمج هنا لجلب آخر 100 شمعة بدقيقة واحدة
    ...
    # استخراج الأسعار بشكل صحيح حسب هيكلة بيانات بينانس والأندكسات المحددة من قبلك
    ...
    # 🌟 رابط كوين جيكو لجلب سعر الذهب المرمّز PAX Gold
